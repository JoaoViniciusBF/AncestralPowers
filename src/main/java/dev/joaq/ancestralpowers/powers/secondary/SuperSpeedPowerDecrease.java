...
public class SuperSpeedPowerDecrease extends PowerBase {
    ...
    private static final UUID SUBMERGED_SPEED_ID = UUID.nameUUIDFromBytes("ancestralpowers:super_submerged_speed".getBytes());
    private static final UUID BLOCK_SPEED_ID = UUID.nameUUIDFromBytes("ancestralpowers:super_block_speed".getBytes());
